          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-6">
              ...
              <div className="hidden sm:flex gap-4">
                ...
                <Link to="/complaints" className="text-sm text-gray-600 hover:text-gray-900">Complaints</Link>
                <Link to="/queries" className="text-sm text-gray-600 hover:text-gray-900">Queries</Link>
                ...
                <Link to="/settings/rules" className="text-sm text-gray-600 hover:text-gray-900">Companies</Link>
                <Link to="/networks" className="text-sm text-gray-600 hover:text-gray-900">Networks</Link>
              </div>
            </div>
            {user && (
